...
class RequestSignInDialogFragment(title: String? = null, message: String? = null):
    TwoButtonDialogFragment(title, message) {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        setSecondOnClickListener(getString(R.string.ok)) {
            (requireActivity() as MainActivity).startSignInFragment()
            dismiss()
        }
